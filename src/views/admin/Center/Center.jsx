...
const header = [
  ...
  { title: "Center Name", prop: "name", sortable: true, filterable: true },
  { title: "Address", prop: "address", sortable: true, filterable: true },
  { title: "Created", prop: "created", sortable: true, filterable: true },
...
class Centers extends Component {
  ...
  async componentDidMount() {
    ...
    this.setState({data: loadedCenters});
              ...
              <div className="col-12">
                <section className="box ">
                  <header className="panel_header">
                    <h2 className="title float-left">All Center</h2>
                  </header>
