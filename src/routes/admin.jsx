...
var dashRoutes = [
  ...
  },
  {
    ...
    child: [
      ...
      { path: "/admin/trainee-profile", name: "Trainee Profile" },
    ],
  },
  ...
  { path: "/admin/trainee-profile", component: TraineeProfile, type: "child" },
  {
    path: "#",
...

  {
    ...
    child: [
      ...
      { path: "/admin/edit-course", name: "Edit Course" },
      { path: "/admin/course-view", name: "View Course" },
    ],
  },
  { path: "/admin/courses", component: Course, type: "child" },
  { path: "/admin/add-course", component: AddCourse, type: "child" },
  { path: "/admin/edit-course", component: EditCourse, type: "child" },
  { path: "/admin/course-view", component: CourseView, type: "child" },
